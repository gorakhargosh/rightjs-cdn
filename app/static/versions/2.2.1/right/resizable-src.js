...
function Widget(tag_name, methods) {
  ...
  // protected
    ...
    setOptions: function(options, element) {
      ...
      if (options) {
        RightJS.Options.setOptions.call(this, Object.merge(this.options, options));
      }
